...
| [DR-045](decisions/045-unified-session-storage.md) | 045-unified-session-storage.md | Proposed shared desktop/CLI sessions: portable history and graph context, optional provider continuity, one Spex home, Git synchronization with whole-session choices |
